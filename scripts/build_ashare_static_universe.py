...
def quality_summary(report: pd.DataFrame, prefilter: pd.DataFrame, ranked: pd.DataFrame, all_a: pd.DataFrame, mainboard: pd.DataFrame, rules: CompletenessRules, args: argparse.Namespace) -> Dict[str, Any]:
    ...
    return {
        ...
        "quality_checks": {
            ...
            "allA_implied_float_shares_unstable_3pct": int(all_a["implied_float_shares_unstable_3pct"].sum()) if "implied_float_shares_unstable_3pct" in all_a else 0,
            "mainboard_implied_float_shares_unstable_3pct": int(mainboard["implied_float_shares_unstable_3pct"].sum()) if "implied_float_shares_unstable_3pct" in mainboard else 0,
            "allA_implied_float_shares_unstable_5pct": int(all_a["implied_float_shares_unstable_5pct"].sum()) if "implied_float_shares_unstable_5pct" in all_a else 0,
            "mainboard_implied_float_shares_unstable_5pct": int(mainboard["implied_float_shares_unstable_5pct"].sum()) if "implied_float_shares_unstable_5pct" in mainboard else 0,
