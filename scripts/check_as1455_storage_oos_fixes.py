...
def check_strict_oos(tmp: Path) -> None:
    ...
    for offset in range(5):
        run_name = f"ensemble_first3_mean_max20_sell150_reb5_off{offset}"
        rows.append(
            {
                "run_name": run_name,
                "status": "ok",
                ...
                "sharpe": 10.0 if offset != 3 else 1.0,
                "total_return": 0.1,
            }
        )
...
def main() -> None:
    ...
    print("[PASS] AS1455 forward dates and strict OOS")
